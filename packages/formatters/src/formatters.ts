 ...
 */
export function formatEmoji<EmojiId extends Snowflake>(emojiId: EmojiId, animated?: false): `<:__:${EmojiId}>`;
 ...
 */
export function formatEmoji<EmojiId extends Snowflake>(emojiId: EmojiId, animated?: true): `<a:__:${EmojiId}>`;
...
export function formatEmoji<EmojiId extends Snowflake, EmojiName extends string>(
	...
	return `<${isAnimated ? 'a' : ''}:${emojiName ?? '__'}:${id}>`;
}
