...
describe('Message formatters', () => {
	...
	describe('formatEmoji', () => {
		test('GIVEN static emojiId THEN returns "<:__:${emojiId}>"', () => {
			expect<`<:__:851461487498493952>`>(formatEmoji('851461487498493952')).toEqual('<:__:851461487498493952>');
		});

		test('GIVEN static emojiId WITH animated explicitly false THEN returns "<:__:[emojiId]>"', () => {
			expect<`<:__:851461487498493952>`>(formatEmoji('851461487498493952', false)).toEqual('<:__:851461487498493952>');
		});

		test('GIVEN animated emojiId THEN returns "<a:__:${emojiId}>"', () => {
			expect<`<a:__:827220205352255549>`>(formatEmoji('827220205352255549', true)).toEqual('<a:__:827220205352255549>');
		});

		test('GIVEN static id in options object THEN returns "<:__:${id}>"', () => {
			expect<`<:__:851461487498493952>`>(formatEmoji({ id: '851461487498493952' })).toEqual('<:__:851461487498493952>');
		});

		test('GIVEN static id in options object WITH animated explicitly false THEN returns "<:__:${id}>"', () => {
			expect<`<:__:851461487498493952>`>(formatEmoji({ animated: false, id: '851461487498493952' })).toEqual(
				'<:__:851461487498493952>',
			);
		});

		test('GIVEN animated id in options object THEN returns "<a:__:${id}>"', () => {
			expect<`<a:__:827220205352255549>`>(formatEmoji({ animated: true, id: '827220205352255549' })).toEqual(
				'<a:__:827220205352255549>',
			);
		});
